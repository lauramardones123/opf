function gestorDatosAC_PSO(Generador::DataFrame, Nodo::DataFrame, nn::Int, bMVA::Int)
    ...
    # Creo un vector que me indice en qué nodo está cada generador
    gen_bus = Generador.BUS
    ...
    return P_Cost0, P_Cost1, P_Cost2, P_Gen_lb, P_Gen_ub, Q_Gen_lb, Q_Gen_ub, S_Demand, V_Nodo_lb, V_Nodo_ub, gen_bus#, Gen_Status
