#### Esta función utiliza la función "elegirOpcion.jl" y es la que se encarga de asignar las opciones que luego se
#### piden al usuario 
...
function selectEstudio()
    ...
    while true
        ...
        opfTip = elegirOpcion(listaOPF, "tipo de OPF") #La función tiene como argumento las opciones y el título
