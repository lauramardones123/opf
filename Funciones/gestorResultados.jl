#### Función que se encarga de gestionar los resultados devueltos por las funciones del OPF y, en caso de que 
#### haya ruta .m, compara el resultado con el obtenido en PowerModels

function gestorResultados(modelo, solGeneradores, solFlujos, solAngulos, solBinaria, rutaM, opfTipo, solver, coste_total)
