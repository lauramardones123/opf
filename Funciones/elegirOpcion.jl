#### Función llamada por "selectEstudio.jl". Es un bucle infinito que pide al usuario elegir una opción entre
#### las disponibles en la lista que tiene como argumento. Si la respuesta es válida, se da la opción pedida
#### pero si es inválida, se vuelve a preguntar al usuario. 
